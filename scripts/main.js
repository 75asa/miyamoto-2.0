...
loadTimesheets = function (exports) {
  ...
  Timesheets.prototype.receiveMessage = function(username, message) {
    ...
    // コマンド集
    var commands = [
      ['actionSignOut', /(バ[ー〜ァ]*イ|ば[ー〜ぁ]*い|おやすみ|お[つっ]ー|おつ|乙丸|乙丸ルイさん|乙まる|お疲れやま|お疲れ山|乙ぽん|ばいちゃ|また会う日まで|さらば|お先|お疲|帰|乙|bye|night|(c|see)\s*(u|you)|退勤|ごきげんよ|グ[ッ]?バイ)/],
      ...
      ['actionSignIn', /(モ[ー〜]+ニン|も[ー〜]+にん|おっは|おは|おは丸|おはまる|おは丸水産|おはざす|Guten Moegen|へろ|はろ|ヘロ|ハロ|hi|hello|morning|出勤)/],
